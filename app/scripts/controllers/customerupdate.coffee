...
###*
 # @ngdoc function
 # @name sosAppApp.controller:CustomerupdateCtrl
 # @description
 # # CustomerupdateCtrl
 # Controller of the sosAppApp
###
angular.module 'sosAppApp'
  .controller 'CustomerupdateCtrl', ($scope, CustomerService, selects, array)->
	$scope.customers = {}
	...
	$scope.customers.updateCustomer = (ds, id) ->
		...
		CustomerService.updateCustomer(ds, id).then (d) ->
